...
| `LIBRARY_PATH_2` / `_3` / `_4` | _(empty)_ | Optional extra storage folders, typically on other drives. They show as one-tap destination chips in the download modal and share the free-space auto-pick above |
