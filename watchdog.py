...
# NIGHT_MODE_PRESETS and run.py's copy — change one, change all three. VLC has
# no runtime HTTP command for audio filters, so the compressor is a launch arg
# gated on the persisted library.json settings. See docs/GOTCHAS.md.
NIGHT_MODE_PRESETS = {
    "light": [
