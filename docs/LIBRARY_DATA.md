  ...
  "<profile_uuid>": {
    ...
    "file_progress": {
      "/abs/path/file.mkv": {
        "position_sec": 1234.5,
        "duration_sec": 4174.0,
        "completed": false,                // VLC path: true once playback reaches the outro (see below). Online writer: pct > 0.92
